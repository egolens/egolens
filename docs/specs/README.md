...
| 006 | [Teachable Lens — portable full-scene adapter recipes](spec_006_teachable_lens.md) | in-progress (Phases 2–5 shipped; Phase 6 gate → spec 012) |
...
| 012 | [Teachable Lens Phase 6 performance and lifecycle gate](spec_012_teachable_lens_phase6_performance_gate.md) | planned; normative addendum to spec 006 Phase 6 |
