...
| 014 | [Teachable Lens Phase 10 original-data generalization ladder](spec_014_teachable_lens_phase10_generalization_ladder.md) | in-progress; preflight 10.P1–P6 implemented, P7 exact-head local/Phase 6 evidence passed, Phase 9 author + freeze pending before A2D2 → KITTI Raw → ONCE → PandaSet ([handoff snapshot](../handoffs/spec_014_p7_dc208e4.md)) |
