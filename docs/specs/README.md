...
| 014 | [Teachable Lens Phase 10 original-data generalization ladder](spec_014_teachable_lens_phase10_generalization_ladder.md) | planned; transport/runtime preflight, then A2D2 → KITTI Raw → ONCE → PandaSet original-drop evidence |
