...
| 006 | [Teachable Lens — portable full-scene adapter recipes](spec_006_teachable_lens.md) | in-progress (Phases 2–5 shipped; Phase 6 cutover implemented, performance/oracle evidence pending → specs 012–013) |
...
| 012 | [Teachable Lens Phase 6 performance and lifecycle gate](spec_012_teachable_lens_phase6_performance_gate.md) | in-progress; runtime/CDP harness implemented, three-dataset evidence pending |
| 013 | [Teachable Lens hidden-oracle retention](spec_013_teachable_lens_hidden_oracle_retention.md) | in-progress; normative addendum to spec 006 Phases 6/9 and spec 012 |
