...
| 006 | [Teachable Lens — portable full-scene adapter recipes](spec_006_teachable_lens.md) | in-progress (Phases 2–5 shipped; Phase 6 cutover implemented, evidence pending → spec 012) |
